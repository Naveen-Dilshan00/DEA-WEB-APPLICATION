           ...
           <div class="full-body">
                         ...
                         <div class="cart">
                            <div class="products">
                                <div class="product" style="overflow-x:auto">
                                        ...
                                        <img class="img-fluid ml-2" src="Items_img/<%=b.getPhotoName()%>">
                ...
                <div class="col-md-7">
                    <div class="card">
                        <div class="card-body">
                            <h5>Your Detailes</h5>
                            <form action="DireOrderServlet" method="POST">
                             ...
                             <div class="form-row">
                              ...
                              <div class="form-row">
                               ...
                               <div class="form-group col-md-6">
                                 ...
                                 <input type="text" class="form-control" id="inputPassword4" placeholder="Zip" name="zip"  required>
                               </div>
